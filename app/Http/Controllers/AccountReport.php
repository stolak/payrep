...
=======
        ...
        if (isset($_POST['del'])) {
            ...
            if (db::table('tblfinancial_end')->where('year_end_date', '>=', $trans_date)->first()) {
                return back()->with('error_message', ' This year perid has already been closed. Hence the transaction not deletable');
            }
