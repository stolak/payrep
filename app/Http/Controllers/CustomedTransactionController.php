    ...
    public function loanDetails(Request $request)
    {
        ...
        if (isset($_POST['liquidate'])) {
            ...
            AccountTrait::debitAccount(
                ...
                'ref',
                $request->input('applyDate'),
                'Liquidation: ' . $request->input('remarks') . ' ' . $customer_details->first_name,
                Auth::User()->id,
                'manual_ref'
            );
        ...
        if (isset($_POST['default'])) {
            ...
            AccountTrait::debitAccount(
                ...
                'ref',
                $request->input('applyDate'),
                'Default charge: ' . $request->input('remarks') . ' ' . $customer_details->first_name,
                Auth::User()->id,
                'manual_ref'
            );
