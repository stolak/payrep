...
<table class="table table-bordered table-striped table-highlight" >
		...
		@endforeach
			<tr> <td>Total</td>
			<td >@if((number_format($totalcredit,2, '.', ',')==number_format($totaldebit,2, '.', ',')) && ($totaldebit >0))<b>Transaction Date:<input type="date" name="ini_transdate" value="{{$data->transdate}}"   class="form-control" style="width:150px;"></b> @endif</td>
			...
			<td >@if((number_format($totalcredit,2, '.', ',')==number_format($totaldebit,2, '.', ',')) && ($totaldebit >0))<b>Ref No: <input type="text" id="manual_ref" name="manual_ref" value="{{$data->manual_ref}}" class="form-control" style="width:250px;" autocomplete="off"></b> @endif </td>
...
<table class="table table-bordered table-striped table-highlight" >
			 ...
			 @foreach($UnpostedJournalPending as $data)
					...
					<a onclick="deletefunc('{{$data->ref}}')" class="btn btn-success">Delete</a>
					</td>
					</tr>
		@endforeach
