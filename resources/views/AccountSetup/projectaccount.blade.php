...
@section('pageHead')
    <div id="page-head">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Petty expense account Setup</a></li>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <?php if($particular=='') $particular= old('particular'); ?>
                                    <input type="text" class="form-control"  value="{{$particular}}" required name="particular">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
		        ...
		        <tbody>
		          ...
		          @endphp
		            ...
		            @foreach($DefaultAccount as $list)
		               ...
		               <td>
		               <a onclick="editfunc('{{$list->id}}','{{$list->expensenid}}','{{$list->particular}}')" class="btn btn-success  glyphicon glyphicon-edit btn-xs"></a>&nbsp;
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">  
                <div class="form-group" style="margin: 0 10px;">
                      ...
                      <div class="col-sm-12">
			             <div class="form-group">
                      <label class="control-label"><h5>Particular: </h5></label>
                      <input type="text" class="form-control" id="brand" name="particular">
                        </div>
                      </div>
                      <div class="col-sm-12">
			             <div class="form-group">
                      <label class="control-label"><h5>Lookup Expense Account: </h5></label>
